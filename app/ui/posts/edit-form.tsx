...
import { UpdatePost } from '../post/buttons';
...
const EditForm = ({post}:{post:Post}) => { 
  ...
  const updateInvoiceWithId = updatePost.bind(null, post.id);
          ...
          <div className="flex gap-4">
            <div className="flex items-center">
              <input
                ...
                type="radio"
                value="public"
                defaultChecked={post.status === "public"}
            ...
            <div className="flex items-center">
              <input
                ...
                type="radio"
                value="private"
                defaultChecked={post.status === 'private'}
                className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
              />
              <label
                htmlFor="private"
